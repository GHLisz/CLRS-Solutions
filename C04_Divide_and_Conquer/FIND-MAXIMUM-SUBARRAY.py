...
class FindMaximumSubarryTestCase(unittest.TestCase):
    ...
    def test_all_negative(self):
        self.assertEqual(find_maximum_subarray([-2, -1, -3, -4], 0, 3), (1, 1, -1))

    def test_cross(self):
        self.assertEqual(find_maximum_subarray([3, -1, 6, -4], 0, 3), (0, 2, 8))

    def test_random(self):
        for _ in range(10000):
            arr = self.random_array()
            _, _, sub1 = find_maximum_subarray(arr, 0, len(arr) - 1)
